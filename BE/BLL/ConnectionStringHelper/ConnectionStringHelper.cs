...
namespace BLL.LoginBLL
{
    public static class ConnectionStringHelper
    {
        ...
        private static string defaultConnectionString = "Data Source=DESKTOP-F0S1C36\\SQLEXPRESS;Initial Catalog=CAFFEE_VINA_DBv1;Persist Security Info=True;User ID=sa;Password=123;Encrypt=False";
